            ...
            <div className='flex flex-row items-center justify-start'>
              <button  className='px-10 mt-8 py-2 bg-[#130F49] text-gray-50 font-light rounded-md text-lg flex flex-row items-center'>
                ...
                <svg
                  ...
                  <div ref={mref} className="my-5 hidden text-green-300 font-semibold font-sans text-lg">Data Successfully Sent </div>
                  <div ref={eref} className="my-5 hidden text-red-300 font-semibold font-sans text-lg">Something Went Wrong </div>
          </form>
    </>
  );
}
